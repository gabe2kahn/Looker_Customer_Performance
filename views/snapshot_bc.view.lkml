view: snapshot_bc {
  ...
  dimension: current_credit_limit_bucket {
    ...
    sql: CASE
      ...
      WHEN ${current_credit_limit} BETWEEN 100 AND 199 THEN 'b. 100-199'
      WHEN ${current_credit_limit} BETWEEN 200 AND 299 THEN 'c. 200-299'
      WHEN ${current_credit_limit} BETWEEN 300 AND 399 THEN 'd. 300-399'
      WHEN ${current_credit_limit} > 400 THEN 'e. 400+'
    END ;;
  }
